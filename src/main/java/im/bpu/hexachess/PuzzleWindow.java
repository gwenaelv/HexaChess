...
public class PuzzleWindow {
    ...
    private void setupBoardPieces(Board board) {
        ...
        if (currentLevel == 1) {
            ...
            board.pieces.put(new AxialCoordinate(0, -5), new Piece(PieceType.KING, false));
            board.pieces.put(new AxialCoordinate(0, -4), new Piece(PieceType.PAWN, false)); // Bloque
            board.pieces.put(new AxialCoordinate(1, -4), new Piece(PieceType.PAWN, false));  // Bloque
            board.pieces.put(new AxialCoordinate(-2, -5), new Piece(PieceType.KING, true));  // Bloque
            ...
            board.pieces.put(new AxialCoordinate(0, -5), new Piece(PieceType.KING, false)); // Roi Noir
    ...
    private void playBlackMove(String moveStr) {
        ...
        AxialCoordinate from = new AxialCoordinate(Integer.parseInt(fromParts[0]), Integer.parseInt(fromParts[1]));
        AxialCoordinate to = new AxialCoordinate(Integer.parseInt(toParts[0]), Integer.parseInt(toParts[1]));
